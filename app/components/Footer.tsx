...
export default function Footer() {
  return (
    <footer className="w-full bg-transparent text-white  border-zinc-800 px-6 py-12 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-0">
          ...
          <div className="flex flex-row md:flex-col gap-4 md:gap-2 items-center w-full md:w-1/3 md:pt-1">
            <Link href="/about" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
            ...
            <Link href="/works" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
              <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
              <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                Works
              </span>
            ...
            <Link href="/recruit" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
              <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
              <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                Recruit
              </span>
          ...
          <div className="flex flex-col space-y-3 w-full md:w-1/3 md:items-end md:pt-1">
            ...
            <div className="flex flex-col md:items-end items-start space-y-1">
              ...
              <a href="mailto:renanimationstudio@gmail.com" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
                <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
              ...
              <a href="https://www.facebook.com/renanimationstudio" target="_blank" rel="noopener noreferrer" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
                <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
                <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                  Facebook
                </span>
              ...
              <a href="https://x.com/RenAnimaStudio" target="_blank" rel="noopener noreferrer" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
                <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
                <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                  X (Twitter)
                </span>
              ...
              <a href="https://www.youtube.com/@RenAnimationStudio" target="_blank" rel="noopener noreferrer" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
                <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
                <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                  YouTube
                </span>
              ...
              {/* TikTok Button */}
              <a href="https://www.tiktok.com/@RenAnimationStudio" target="_blank" rel="noopener noreferrer" className="group relative inline-flex overflow-hidden cursor-pointer px-4 py-1">
                <span className="absolute inset-0 bg-[#2563eb] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out" />
                <span className="relative z-10 text-sm text-zinc-400 group-hover:text-black font-bold tracking-widest uppercase transition-colors duration-300">
                  TikTok
                </span>
